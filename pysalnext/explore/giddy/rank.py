...
class Theta:
    ...
    >>> from pysalnext.explore.giddy.api import Theta
    >>> import numpy as np
...
class Tau:
    ...
    >>> from pysalnext.explore.giddy.api import Tau
    >>> x1 = [12, 2, 1, 12, 2]
    >>> x2 = [1, 4, 7, 1, 0]
    >>> kt = Tau(x1,x2)
    >>> kt.tau
...
class SpatialTau(object):
    ...
    >>> import pysalnext.lib.api as ps
    >>> import numpy as np
    >>> from pysalnext.explore.giddy.api import SpatialTau
...
class Tau_Local:
    ...
    >>> import pysalnext.lib
    >>> import numpy as np
    >>> from pysalnext.explore.giddy.api import Tau_Local,Tau
    >>> np.random.seed(10)
    >>> f = pysalnext.lib.open(pysalnext.lib.examples.get_path("mexico.csv"))
    >>> vnames = ["pcgdp%d"%dec for dec in range(1940, 2010, 10)]
    >>> y = np.transpose(np.array([f.by_col[v] for v in vnames]))
...
class Tau_Local_Neighbor:
    ...
    >>> import pysalnext.lib.api as ps
    >>> import numpy as np
    >>> from pysalnext.explore.giddy.api import Tau_Local_Neighbor, SpatialTau
    >>> np.random.seed(10)
    >>> f = pysalnext.lib.open(pysalnext.lib.examples.get_path("mexico.csv"))
    >>> vnames = ["pcgdp%d"%dec for dec in range(1940, 2010, 10)]
    >>> y = np.transpose(np.array([f.by_col[v] for v in vnames]))
...
class Tau_Local_Neighborhood:
    ...
    >>> import pysalnext.lib
    >>> import pysalnext.lib.api as ps
    >>> from pysalnext.explore.giddy.api import Tau_Local_Neighborhood
    >>> import numpy as np
    >>> np.random.seed(10)
    >>> f = pysalnext.lib.open(pysalnext.lib.examples.get_path("mexico.csv"))
    >>> vnames = ["pcgdp%d"%dec for dec in range(1940, 2010, 10)]
...
class Tau_Regional:
    ...
    >>> import pysalnext.lib
    >>> import numpy as np
    >>> from pysalnext.explore.giddy.api import Tau_Regional
    >>> np.random.seed(10)
    >>> f = pysalnext.lib.open(pysalnext.lib.examples.get_path("mexico.csv"))
    >>> vnames = ["pcgdp%d"%dec for dec in range(1940, 2010, 10)]
    >>> y = np.transpose(np.array([f.by_col[v] for v in vnames]))
