...
class TestGWRGaussian(unittest.TestCase):
    def setUp(self):
        ...
        self.BS_F = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'georgia/georgia_BS_F_listwise.csv'))
        self.BS_NN = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'georgia/georgia_BS_NN_listwise.csv'))
        self.GS_F = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'georgia/georgia_GS_F_listwise.csv'))
        self.GS_NN =pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'georgia/georgia_GS_NN_listwise.csv'))
...
class TestGWRPoisson(unittest.TestCase):
    def setUp(self):
        ...
        data = pysalnext.lib.open(data_path, mode='Ur')
        ...
        self.BS_F = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'tokyo/tokyo_BS_F_listwise.csv'))
        self.BS_NN = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'tokyo/tokyo_BS_NN_listwise.csv'))
        self.GS_F = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'tokyo/tokyo_GS_F_listwise.csv'))
        self.GS_NN = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'tokyo/tokyo_GS_NN_listwise.csv'))
        self.BS_NN_OFF = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'tokyo/tokyo_BS_NN_OFF_listwise.csv'))
...
class TestGWRBinomial(unittest.TestCase):
    def setUp(self):
        ...
        self.BS_F = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'clearwater/clearwater_BS_F_listwise.csv'))
        self.BS_NN = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'clearwater/clearwater_BS_NN_listwise.csv'))
        self.GS_F = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'clearwater/clearwater_GS_F_listwise.csv'))
        self.GS_NN = pysalnext.lib.open(os.path.join(os.path.dirname(__file__),'clearwater/clearwater_GS_NN_listwise.csv'))
