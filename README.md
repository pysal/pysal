...
PySAL is available through [Anaconda](https://www.continuum.io/downloads) (in the defaults or [conda-forge](https://conda-forge.org) channel) We recommend installing PySAL from conda-forge:
