# -*- coding: utf-8 -*-
#
# spglm documentation build configuration file, created by
...
project = "spglm"  # string of your project name, for example, 'giddy'
...
#
# The full version.
version = spglm.__version__ #should replace it with your PACKAGE_NAME
release = spglm.__version__ #should replace it with your PACKAGE_NAME
...
html_theme_options = {
    ...
    'navbar_title': "spglm", # string of your project name, for example, 'giddy'
...
latex_documents = [
    (master_doc, 'spglm.tex', u'spglm Documentation',
...
man_pages = [
    (master_doc, 'spglm', u'spglm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'spglm', u'spglm Documentation',
     author, 'spglm', 'Sparse generalized linear models',
     'Miscellaneous'),
]
