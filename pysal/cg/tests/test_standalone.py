...
class TestIsCollinear(unittest.TestCase):
    def test_is_collinear(self):
        self.assertEqual(True, is_collinear(Point((0, 0)), Point((1, 1)), Point((5, 5))))
    def test_is_collinear_expectFalse(self):
        self.assertEqual(False, is_collinear(Point((0, 0)), Point((1, 1)), Point((5, 0))))
    def test_is_collinear_AlongX(self):
        self.assertEqual(True, is_collinear(Point((0, 0)), Point((1, 0)), Point((5, 0))))
    def test_is_collinear_AlongY(self):
        self.assertEqual(True, is_collinear(Point((0, 0)), Point((0, 1)), Point((0, -1))))
...
class TestGetRectangleRectangleIntersection(unittest.TestCase):
    ...
    def test_get_rectangle_rectangle_intersection_shared_edge(self):
        ...
        self.assertEqual(LineSegment(Point((0,4)),Point((4,4))), get_rectangle_rectangle_intersection(r0, r1))
    def test_get_rectangle_rectangle_intersection_shifted_edge(self):
        r0 = Rectangle(0,0,4,4)
        r1 = Rectangle(2,4,6,8)
        self.assertEqual(LineSegment(Point((2,4)),Point((4,4))), get_rectangle_rectangle_intersection(r0, r1))
...
class TestConvexHull(unittest.TestCase):
    def test_convex_hull(self):
        ...
        self.assertEqual([Point((0.0, 0.0)), Point((4.0, 0.0)), Point((4.0, 4.0))], convex_hull(points))
...
class TestIsClockwise(unittest.TestCase):
    ...
    def test_is_clockwise_big(self):
        vertices = [(-106.57798, 35.174143999999998), (-106.583412, 35.174141999999996),
                    (-106.58417999999999, 35.174143000000001), (-106.58377999999999, 35.175542999999998),
                    (-106.58287999999999, 35.180543), (-106.58263099999999, 35.181455),
                    (-106.58257999999999, 35.181643000000001), (-106.58198299999999, 35.184615000000001),
                    (-106.58148, 35.187242999999995), (-106.58127999999999, 35.188243),
                    (-106.58138, 35.188243), (-106.58108, 35.189442999999997),
                    (-106.58104, 35.189644000000001), (-106.58028, 35.193442999999995),
                    (-106.580029, 35.194541000000001), (-106.57974399999999, 35.195785999999998),
                    (-106.579475, 35.196961999999999), (-106.57922699999999, 35.198042999999998),
                    (-106.578397, 35.201665999999996), (-106.57827999999999, 35.201642999999997),
                    ...
                    (-106.56048, 35.197342999999996), (-106.56048, 35.195842999999996),
                    (-106.56048, 35.194342999999996), (-106.56048, 35.193142999999999),
                    (-106.56048, 35.191873999999999), (-106.56048, 35.191742999999995),
                    (-106.56048, 35.190242999999995), (-106.56037999999999, 35.188642999999999),
                    ...
                    (-106.56037999999999, 35.174043999999995), (-106.560526, 35.174043999999995),
                    (-106.56478, 35.174043999999995), (-106.56627999999999, 35.174143999999998),
                    (-106.566541, 35.174144999999996), (-106.569023, 35.174157000000001),
                    (-106.56917199999999, 35.174157999999998), (-106.56938, 35.174143999999998),
