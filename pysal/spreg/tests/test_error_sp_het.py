...
class TestBaseGMErrorHet(unittest.TestCase):
    ...
    def test_model(self):
        ...
        betas = np.array([[47.99626638], [0.71048989], [-
                                                        0.55876126], [0.41178776]])
...
class TestGMErrorHet(unittest.TestCase):
    ...
    def test_model(self):
        ...
        stde = np.array(
            [11.47900385, 0.36812187, 0.16156816, 0.16804717])
...
class TestBaseGMEndogErrorHet(unittest.TestCase):
    ...
    def test_model(self):
        ...
        betas = np.array([[55.39707924], [0.46563046], [-
                                                        0.67038326], [0.41135023]])
        np.testing.assert_array_almost_equal(reg.betas, betas, 7)
...
class TestBaseGMComboHet(unittest.TestCase):
    ...
    def test_model(self):
        ...
        reg = HET.BaseGM_Combo_Het(
            self.y, self.X, yend=yd2, q=q2, w=self.w, step1c=True)
        betas = np.array([[57.7778574], [0.73034922], [-
                                                       0.59257362], [-0.2230231], [0.56636724]])
        np.testing.assert_array_almost_equal(reg.betas, betas, 7)
...
class TestGMComboHet(unittest.TestCase):
    ...
    def test_model(self):
        ...
        std_err = np.array([22.05035768, 0.32354439, 0.14685221,
                            0.52751653, 0.26683966])
        np.testing.assert_array_almost_equal(reg.std_err, std_err, 6)
