...
class TestBaseTSLS(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        predy_5 = np.array([[-28.68949467], [28.99484984], [
            55.07344824], [38.26609504], [57.57145851]])
        ...
        u_5 = np.array([[44.41547467], [-10.19309584], [-
                                                        24.44666724], [-5.87833504], [-6.83994851]])
        ...
        y_5 = np.array([[15.72598], [18.801754], [30.626781], [
            32.38776], [50.73151]])
        np.testing.assert_array_almost_equal(reg.y[0:5], y_5, 7)
        yend_5 = np.array([[80.467003], [44.567001], [26.35], [
            33.200001], [23.225]])
