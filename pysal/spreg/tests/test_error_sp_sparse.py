...
class TestBaseGMError(unittest.TestCase):
    ...
    def test_model(self):
        ...
        betas = np.array([[47.94371455], [0.70598088], [-
                                                        0.55571746], [0.37230161]])
...
class TestGMError(unittest.TestCase):
    ...
    def test_model(self):
        ...
        z_stat = np.array([[3.89022140e+00, 1.00152805e-04], [1.41487186e+00,
                                                              1.57106070e-01], [-3.11175868e+00, 1.85976455e-03]])
...
class TestBaseGMEndogError(unittest.TestCase):
    ...
    def test_model(self):
        ...
        betas = np.array([[55.36095292], [0.46411479], [-
                                                        0.66883535], [0.38989939]])
        np.testing.assert_array_almost_equal(reg.betas, betas, 6)
...
class TestGMEndogError(unittest.TestCase):
    ...
    def test_model(self):
        ...
        np.testing.assert_array_almost_equal(reg.std_err, std_err, 6)
        z_stat = np.array([[2.40664208, 0.01609994], [0.63144305,
                                                      0.52775088], [-1.75659016, 0.07898769]])
        np.testing.assert_array_almost_equal(reg.z_stat, z_stat, 6)
...
class TestBaseGMCombo(unittest.TestCase):
    ...
    def test_model(self):
        ...
        betas = np.array([[57.61123461], [0.73441314], [-
                                                        0.59459416], [-0.21762921], [0.54732051]])
...
class TestGMCombo(unittest.TestCase):
    ...
    def test_model(self):
        ...
        betas = np.array([[57.61123515], [0.73441313], [-
                                                        0.59459416], [-0.21762921], [0.54732051]])
        np.testing.assert_array_almost_equal(reg.betas, betas, 6)
        u = np.array([25.57932637])
        np.testing.assert_array_almost_equal(reg.u[0], u, 6)
        ...
        std_err = np.array(
            [22.85692222, 0.48786559, 0.17914356, 0.46449318])
