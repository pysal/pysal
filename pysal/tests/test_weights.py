...
class _TestWeights(unittest.TestCase):
    ...
    def test_w_f_shp(self):
        ...
        self.assertEquals(w.s0,572.0)
        self.assertEquals(w.s1,1144.0)
        self.assertEquals(w.s2array[23],100.)
        self.assertEquals(w.trcW2,572.)
        self.assertEquals(w.diagW2[23],5.)
        self.assertEquals(w.diagWtW[23],5.)
        self.assertEquals(w.trcWtW,572.)
        self.assertEquals(w.diagWtW_WW[23],10.)
        self.assertEquals(w.trcWtW_WW,2*572.)
        self.assertEquals(w.pct_nonzero,0.030925605536332178)
        self.assertEquals(w.cardinalities[2],4)
        self.assertEquals(w.max_neighbors,10)
        self.assertEquals(w.min_neighbors,1)
        self.assertEquals(w.nonzero,572)
        self.assertEquals(w.sd,2.2495674324674049)
        ...
        w.transform='v'
        self.assertEquals(w.weights[2],[0.25489183373100938, 0.25489183373100938, 0.25489183373100938, 0.25489183373100938])
        w.transform='b'
        self.assertEquals(w.weights[2],[1.0,1.0,1.0,1.0])
