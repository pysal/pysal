...
class Base_SMASMA(Base_Generic):
    """
    All arguments to this function are documented in SMASMA
    """
...
class SMASMA(Base_SMASMA):
    """
    This is a class that provides the generic structures required for the two-level variance components model with spatial moving average error processes in both levels.
