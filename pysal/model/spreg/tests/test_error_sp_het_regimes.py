...
import numpy as np
from pysalnext.model.spreg import error_sp_het_regimes as SP
from pysalnext.model.spreg.error_sp_het import GM_Error_Het, GM_Endog_Error_Het, GM_Combo_Het
