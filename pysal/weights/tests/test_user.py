...
class Testuser(unittest.TestCase):
    def setUp(self):
        self.wq = pysal.queen_from_shapefile(pysal.examples.get_path("columbus.shp"))
        self.wr = pysal.rook_from_shapefile(pysal.examples.get_path("columbus.shp"))
    ...
    def test_knnW_from_shapefile(self):
        ...
        wc3=pysal.knnW_from_shapefile(pysal.examples.get_path("columbus.shp"),k=3,idVariable="POLYID")
        ...
        w1=pysal.knnW_from_shapefile(pysal.examples.get_path('juvenile.shp'),k=1)
    ...
    def test_threshold_binaryW_from_array(self):
        ...
        self.assertEquals(w.weights, {0: [1, 1], 1: [1, 1], 2: [], 3: [1, 1], 4: [1], 5: [1]})
        self.assertEquals(w.neighbors, {0: [1, 3], 1: [0, 3], 2: [], 3: [0, 1], 4: [5], 5: [4]})

    def test_threshold_binaryW_from_shapefile(self):

        w = pysal.threshold_binaryW_from_shapefile(pysal.examples.get_path("columbus.shp"),0.62,idVariable="POLYID")
    ...
    def test_threshold_continuousW_from_array(self):
        ...
        self.assertEquals(wid.weights[0], [0.10000000000000001, 0.089442719099991588])
    ...
    def test_kernelW(self):
        ...
        self.assertEquals(kw.weights[0], [1.0, 0.50000004999999503, 0.44098306152674649])
