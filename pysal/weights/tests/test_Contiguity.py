...
class TestContiguity(unittest.TestCase):
    def setUp(self):
        self.polyShp = 'pysal/examples/10740.shp'
    ...
    def test_buildContiguity(self):
        ...
        w = pysal.buildContiguity(pysal.open(self.polyShp, 'r'), criterion='queen')
        self.assertEqual(w.pct_nonzero, 0.031926364234056544)
        w = pysal.buildContiguity(pysal.open(self.polyShp, 'r'), criterion='rook')
