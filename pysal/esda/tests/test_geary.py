...
class Geary_Tester(unittest.TestCase):
    ...
    def test_Geary(self):
        ...
        self.assertAlmostEquals(c.p_norm, 0.00040151853759384792 )
        ...
        self.assertAlmostEquals(c.p_rand, 0.0012899524657881134 )
        ...
        self.assertAlmostEquals(c.p_sim, 0.0 )
        self.assertAlmostEquals(c.p_z_sim, 2.834991649147689e-05 )
