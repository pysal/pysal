...
- when calculating simulations envelopes, can we simulate CSR inside the Genv class?
"""
...
def _g(pp, intervals=10, dmin=0.0, dmax=None, d=None):
    ...
    -------
             : array
               ...
               for the point pattern. The second column is the cumulative nearest neighbor distance
               distribution.
